...
export default function Achievements() {
    ...
    return (
        <section className="py-0 h-full col-span-5 flex flex-col">
            <div className="h-full flex flex-col justify-center bg-[#13131a] rounded-[2rem] md:rounded-[3rem] p-6 md:p-12 border border-white/5">
                <div className="flex flex-col items-center md:items-start text-center md:text-left gap-6 md:gap-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 w-full">
                        {stats.map((stat, index) => (
                            <div key={index} className="flex flex-col items-center md:items-start gap-2">
                                ...
                                <span className="text-white/20 text-[10px] font-black tracking-[0.2em] uppercase">
                                    {stat.label}
                                </span>
                            </div>
                        ))}
